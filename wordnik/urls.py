...
urlpatterns = patterns('',
    ...
    url(r'^analysis/(?P<analysis_id>\d+)/$', 'market.views.analysisDetail'),
    url(r'^analysis/all', 'market.views.analysisAll'),
    url(r'^analysis/add/$', 'market.views.analysisAdd'),
    url(r'^analysis/addStream', 'market.views.analysisStreamAdd'),
